...
export const funds: FundProfile[] = [
  {
    ...
    nameZh: "态势感知基金",
    nameEn: "Situational Awareness LP",
    managerZh: "利奥波德·阿申布伦纳",
    managerEn: "Leopold Aschenbrenner",
    ...
    description: "2024年成立的AI主题全球股票投资机构。它关注的不只是模型公司，还包括芯片、存储、数据中心、电力与算力基础设施，并通过期权管理行业估值风险。",
  ...
  },
  {
    ...
    description: "Michael Burry以深度基本面研究和逆向判断著称。他会寻找被忽视的便宜资产，也会在宏观风险足够突出时建立高度集中的做空或期权仓位。",
  ...
  },
  {
    id: "atreides",
    nameZh: "阿特雷德斯管理",
    nameEn: "Atreides Management",
    managerZh: "加文·贝克",
    managerEn: "Gavin Baker",
  ...
  },
  {
    id: "baupost",
    nameZh: "包波斯特集团",
    nameEn: "The Baupost Group",
    managerZh: "塞思·卡拉曼",
    managerEn: "Seth Klarman",
  ...
  },
  {
    id: "pershing-square",
    nameZh: "潘兴广场资本",
    nameEn: "Pershing Square Capital Management",
    managerZh: "比尔·阿克曼",
